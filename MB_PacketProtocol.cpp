...
namespace MBPM
{
		...
		MBPM_FileInfoExcluder& FileInfoExcluder,MBCrypto::HashFunction HashFunctionToUse,uint64_t* OutFileSize)
	{
		...
		char StructureHash[20]; //TODO hardcoda inte hash l�ngden...
		FileToWriteTo->Write(StructureHash, 20);
		char ContentHash[20]; //TODO hardcoda inte hash l�ngden...
	...
	void MBPP_FileInfoReader::UpdateFileInfo(MBPP_FileInfoReader& ReaderToUpdate, std::string const& FileInfoDirectory)
	{
	...
	)
	{
		...
		ReturnValue.LastWriteTime = p_GetPathWriteTime(DirectoryPath);
